<template>
  <div id="about" class="flex flex-col mb-2">
    <div class="space-y-4 flex flex-col justify-center m-auto">
      ...
      <div ref="languages-div" class="flex mx-auto mb-4 content-center p-4 space-x-8">
      ...
      <div class="flex mx-auto">
        ...
        <button
          v-Ripple
          class="flex-1 md:w-30 text-base sm:text-lg outline-none px-8 py-2 rounded-lg bg-colorPrimaryLight text-colorOnPrimaryLight"
        >
          <NuxtLink href="https://t.me/N3Shemmy3"> Contact me </NuxtLink>
        </button>
      </div>
    </div>
  </div>
