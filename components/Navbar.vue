<template>
  <div
    id="Toolbar"
    class="fixed top-0 z-50 h-14 w-full backdrop-filter bg-opacity-40 dark:bg-opacity-80 border-b bg-colorSurfaceLight dark:bg-colorSurfaceDark dark:border-zinc-800 border-gray-50 firefox:bg-opacity-90 backdrop-blur-lg text-colorOnSurfaceLight dark:text-colorOnSurfaceDark"
  >
    <div class="max-w-screen-lg m-auto flex px-4 py-2 space-x-4 items-center">
      <NuxtLink class="flex select-none" to="/">
        <div
          class="flex noSelect justify-center content-center hover:text-colorPrimaryLight dark:hover:text-colorPrimaryDark"
        >
          <Icon class="sm:inline hidden me-1" name="ph:terminal-window" size="28px" />
