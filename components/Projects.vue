<template>
	<div id="projects-title" class="mt-24">
		...
		<div class="flex flex-col shadow-sm m-2">
			...
			<div class="h-4/6 p-2 rounded-b-lg bg-colorSecondaryContainerDark">
				<p
					>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolores,
					itaque adipisci? Odio, reprehenderit, animi aut illum ut corrupti
					earum nemo odit obcaecati quia iste dignissimos sit dolor atque
					pariatur ducimus!</p
				>
			</div>
		</div>
